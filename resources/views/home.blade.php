...
@section('content')
  ...
  <div class="position-relative" style="z-index: 2;">
    <img src="{{ asset('img/hotel_lobby.jpg') }}" alt="hotel" class="img-fluid w-100 lobbyImage" style="max-height: 600px; object-fit: cover;">
  </div>
</main>
    ...
    <div class="col">
      <div class="card h-100">
        <div class="bg-light text-center" style="height: 350px; overflow: hidden;">
          <main class="container my-5">
  <div class="position-relative" style="z-index: 2;">
    <img src="{{ asset('img/bedroom2.jpg') }}" alt="hotel" class="img-fluid w-200 lobbyImage" style="height: 950x; object-fit: cover;">
  </div>
</main>
